...
lcd_init(void) {
    ...
    lcd_signal.GPIO_Pinconfig.GPIO_PinOPType = GPIO_OUT_TYPE_PP;
    lcd_signal.GPIO_Pinconfig.GPIO_PinPuPdControl = GPIO_NO_PUPD;
    lcd_signal.GPIO_Pinconfig.GPIO_PinOPSpeed = GPIO_OUT_SPEED_FAST;
