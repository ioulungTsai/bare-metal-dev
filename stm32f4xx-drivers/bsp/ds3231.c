...
void
ds3231_set_current_time(RTC_time_t* rtc_time) {
    uint8_t seconds, hrs;
...
void
ds3231_set_current_date(RTC_date_t* rtc_date) {
...
void
ds3231_get_current_time(RTC_time_t* rtc_time) {
...
void
ds3231_get_current_date(RTC_date_t* rtc_date) {
...
static void
ds3231_write(uint8_t value, uint8_t reg_addr) {
    uint8_t tx[2];
    tx[0] = reg_addr;
    tx[1] = value;
