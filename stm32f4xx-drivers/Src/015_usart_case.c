...
void
USART2_GPIOInit(void) {
    GPIO_Handle_t usart_gpios;

    usart_gpios.pGPIOx = GPIOA;
    usart_gpios.GPIO_Pinconfig.GPIO_PinMode = GPIO_MODE_ALTFN;
    usart_gpios.GPIO_Pinconfig.GPIO_PinOPType = GPIO_OUT_TYPE_PP;
    usart_gpios.GPIO_Pinconfig.GPIO_PinPuPdControl = GPIO_PIN_PU;
    usart_gpios.GPIO_Pinconfig.GPIO_PinOPSpeed = GPIO_OUT_SPEED_FAST;
...
void
USART_ApplicationEventCallback(USART_Handle_t* pUSARTHandle, uint8_t ApEv) {
