...
// Very large message
uint8_t tr_buf[] = "The sun set over the horizon, painting the sky in hues of orange and pink. Birds chirped their final songs of the day as a gentle breeze rustled through the trees. In the distance, the sound of waves crashing against the shore could be heard, creating a serene backdrop. Families strolled along the beach, children laughing and playing in the sand. It was a perfect evening, one that would be remembered fon";
